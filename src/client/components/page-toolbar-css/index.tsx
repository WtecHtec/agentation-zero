...
type OutputDetailLevel = "minimal" | "compact" | "standard" | "detailed" | "forensic";
...
const OUTPUT_DETAIL_OPTIONS: { value: OutputDetailLevel; label: string }[] = [
  { value: "minimal", label: UI_TEXT.minimal },
  { value: "compact", label: UI_TEXT.compact },
  { value: "standard", label: UI_TEXT.standard },
  { value: "detailed", label: UI_TEXT.detailed },
  { value: "forensic", label: UI_TEXT.forensic },
];
...
function generateOutput(
  ...
  annotations.forEach((a, i) => {
    if (detailLevel === "minimal") {
      output += `**Locator:** ${a.sourceLocation || a.elementPath}\n`;
  ...
  const createMultiSelectPendingAnnotation = useCallback(() => {
    ...
    if (!isMulti) {
      ...
      setPendingAnnotation({
        ...
        sourceLocation: firstEl.getAttribute("data-agentation-location") || undefined,
      });
    } else {
  ...
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      ...
      setPendingAnnotation({
        ...
        sourceLocation: elementUnder.getAttribute("data-agentation-location") || undefined,
      });
      setHoverInfo(null);
    };
      ...
      >
        ...
        <div
          ...
          tabIndex={!isActive ? 0 : -1}
                title={!isActive ? UI_TEXT.toggleTooltip : undefined}
          style={{
            ...(isDraggingToolbar && {
          ...
          >
            ...
            >
              ...
              <span className={styles.buttonTooltip}>
                {isFrozen ? UI_TEXT.resumeAnimations : UI_TEXT.pauseAnimations}
            ...
            <div className={styles.buttonWrapper}>
              ...
              <span className={styles.buttonTooltip}>
                {showMarkers ? UI_TEXT.hideMarkers : UI_TEXT.showMarkers}
            ...
            <div className={styles.buttonWrapper}>
              ...
              <span className={styles.buttonTooltip}>{UI_TEXT.settings}</span>
            </div>
              ...
              >
                ...
                <div className={styles.settingsSection}>
                  <div className={styles.settingsRow}>
                    ...
                    >
                      {UI_TEXT.outputDetail}
                      <Tooltip content={UI_TEXT.outputDetailTooltip}>
                  ...
                  >
                    <div
                      className={`${styles.settingsLabel} ${!isDarkMode ? styles.light : ""}`}
                    >
                      {UI_TEXT.reactComponents}
                      <Tooltip
                        content={
                          !isLocalhost
                            ? UI_TEXT.reactComponentsTooltipDisabled
                            : UI_TEXT.reactComponentsTooltip
                        }
                      >
                        <span className={styles.helpIcon}>
                          <IconHelp size={20} />
                ...
                <div className={styles.settingsSection}>
                  <label className={styles.settingsToggle}>
                    ...
                    >
                      {UI_TEXT.autoClear}
                      <Tooltip content={UI_TEXT.autoClearTooltip}>
                        <span
              ...
              >
                ...
                >
                  <div className={styles.settingsRow}>
                    ...
                    >
                      {UI_TEXT.webhooks}
                      <Tooltip content={UI_TEXT.webhookUrlTooltip}>
                        <span
                  ...
                  >
                    {UI_TEXT.webhookUrlDescription}
                  </p>
                  <textarea
                    className={`${styles.webhookUrlInput} ${!isDarkMode ? styles.light : ""}`}
                    placeholder={UI_TEXT.webhookUrlPlaceholder}
